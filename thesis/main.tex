...
% ============================================================================
\title{Simulación del colapso gravitacional de una cáscara de materia\\
       hacia una configuración de \emph{Black Shell}}
...
\input{chapters/03_cascara_polvo}
\input{chapters/04_implementacion_numerica}
\input{chapters/05_resultados}
\input{chapters/06_extensiones}
